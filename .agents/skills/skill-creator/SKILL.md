...
1. **Location**: Placed in `.agents/skills/<skill-name>/`.
...
1. Create the directory: `mkdir -p .agents/skills/<name>/scripts`
...
```bash
./.agents/skills/skill-creator/scripts/validate_skills.sh
```

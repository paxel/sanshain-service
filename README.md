...
Download the binary for your architecture from the [Releases](https://github.com/paxel/sanshain-service/releases) page, or use Docker:
...
See the [Developer Guide](docs/developer-guide.md) for more details.

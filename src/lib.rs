...
pub fn create_app(state: AppState) -> Router {
    Router::new()
        ...
        .route("/admin/services", get(admin::admin_list_services).layer(from_fn_with_state(state.clone(), admin_auth)))
        .route("/admin/services/{name}", delete(admin::admin_delete_service).layer(from_fn_with_state(state.clone(), admin_auth)))
        .route("/admin/services/{name}/branches", get(admin::admin_list_branches).layer(from_fn_with_state(state.clone(), admin_auth)))
        ...
        .route("/admin/services/{name}/branches/{branch}/endpoints", get(admin::admin_list_service_endpoints).layer(from_fn_with_state(state.clone(), admin_auth)))
        .route("/admin/clients", get(admin::admin_list_clients).layer(from_fn_with_state(state.clone(), admin_auth)))
        .route("/admin/clients/{name}", delete(admin::admin_delete_client).layer(from_fn_with_state(state.clone(), admin_auth)))
        .route("/admin/clients/{name}/branches", get(admin::admin_list_client_branches).layer(from_fn_with_state(state.clone(), admin_auth)))
        .route("/admin/clients/{name}/branches/{branch}/endpoints", get(admin::admin_list_client_endpoints).layer(from_fn_with_state(state.clone(), admin_auth)))
        .route("/admin/endpoint-yaml", get(admin::admin_get_endpoint_yaml).layer(from_fn_with_state(state.clone(), admin_auth)))
        .route("/admin/endpoint-versions", get(admin::admin_get_endpoint_versions).layer(from_fn_with_state(state.clone(), admin_auth)))
